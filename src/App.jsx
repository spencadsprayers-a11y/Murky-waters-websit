...
const teamLink = https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(   "Hi, I’m interested in joining the Murky Waters team."   )};

const ProductCard = ({ name, qty, price, onMinus, onPlus, tag, desc }) => (
<div
className={relative rounded-3xl border p-4 text-center ${   qty > 0   ? "border-yellow-400 bg-yellow-400/10 shadow-lg shadow-yellow-500/20"   : "border-white/10 bg-zinc-950"   }}
>
{tag && (
